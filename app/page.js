          ...
          <div className="flex flex-col md:flex-row justify-center items-center justify-items-center md:ml-5">
            ...
            >
              <p className="h-auto md:text-lg lg:text-2xl">
                ...
                lo que me permite crear soluciones completas y funcionales. Me
                especializo en el front-end, trabajando con tecnologías como
                HTML, CSS y JavaScript, con el objetivo de lograr aplicaciones
                ...
                eficiente. También estoy familiarizado con frameworks como
                React, Vite y NextJs. Estoy constantemente aprendiendo y
                adaptándome a las últimas tendencias tecnológicas para brindar
            ...
            <div className="absolute inset-0 flex md:mt-10 items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
              <div className="text-white text-center overflow-y-scroll h-full">
                ...
                <p
                  ...
                  className="text-xl font-bold text-[#6E07F3] px-3 mb-2"
                >
                  Foccus es una óptica que integra un e-commerce y un gestor de
                  turnos para realizar el cambio o compra de gafas{" "}
                </p>
                <p className="font-mono text-xl font-bold text-black px-3 mb-2">
                  HTML | Taildwind CSS | JavaScript | NextJs{" "}
                </p>
            ...
            <div className="absolute inset-0 flex md:mt-10 items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
              <div className="text-white text-center overflow-y-scroll h-full">
                ...
                <p
                  ...
                  className="text-xl font-bold text-[#6E07F3] px-3 mb-2"
                >
                  Code Partners representa a un equipo de trabajo para proyectos
                  a escala que necesiten personas capacitadas y de calidad que
                  brinden una solución integral a los requerimientos del cliente{" "}
                </p>
                <p className="font-mono text-xl font-bold text-black px-3 mb-2">
                  HTML | Taildwind CSS | JavaScript | NextJs{" "}
                </p>
